...
const runMigrations = async () => {
    const ddlQuery = `
        ...
        INSERT INTO Rol (RolName) SELECT 'ADMIN' WHERE NOT EXISTS (SELECT 1 FROM Rol WHERE RolName = 'ADMIN');
        INSERT INTO Rol (RolName) SELECT 'USER' WHERE NOT EXISTS (SELECT 1 FROM Rol WHERE RolName = 'USER');
        
        INSERT INTO Rol_Opciones (NombreOpcion) SELECT 'WELCOME' WHERE NOT EXISTS (SELECT 1 FROM Rol_Opciones WHERE NombreOpcion = 'WELCOME');
        INSERT INTO Rol_Opciones (NombreOpcion) SELECT 'MAINTENANCE' WHERE NOT EXISTS (SELECT 1 FROM Rol_Opciones WHERE NombreOpcion = 'MAINTENANCE');
        INSERT INTO Rol_Opciones (NombreOpcion) SELECT 'DASHBOARD_STATS' WHERE NOT EXISTS (SELECT 1 FROM Rol_Opciones WHERE NombreOpcion = 'DASHBOARD_STATS');
    ...
    try {
        ...
        await postgres_1.pool.query(ddlQuery);
